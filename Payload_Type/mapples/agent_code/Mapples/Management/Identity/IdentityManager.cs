...
using static MapplesInterop.Enums.Win32;
using static MapplesInterop.Constants.Win32;
using System.Runtime.InteropServices;
using static MapplesInterop.Structs.Win32;
using MapplesInterop.Structs.MythicStructs;
using System.Security;

namespace Mapples.Management.Identity
{
    public class IdentityManager : IIdentityManager
    {
        private IAgent _agent;

        private MapplesLogonInformation _userCredential;
        ...
        public bool SetIdentity(MapplesLogonInformation logonInfo)
        {
            bool bRet = false;
            int dwError = 0;
        ...
        public void Revert()
        {
            ...
            _userCredential = new MapplesLogonInformation();
        ...
        public bool GetCurrentLogonInformation(out MapplesLogonInformation logonInfo)
        {
            ...
            logonInfo = new MapplesLogonInformation();
            return false;
        }
    }
}
