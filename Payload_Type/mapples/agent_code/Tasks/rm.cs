...
namespace Tasks
{
    public class rm : Tasking
    {
        ...
        public rm(IAgent agent, MapplesInterop.Structs.MythicStructs.Task data) : base(agent, data)
        {
        }
        ...
        public override void Start()
        {
            ...
            if (MapplesInterop.Utils.PathUtils.TryGetExactPath(path, out realPath))
            {
