using MapplesInterop.Classes.Collections;
...
namespace MapplesInterop.Structs.MapplesStructs
{
    ...
    public struct MapplesTokenInformation
    {
        public IntPtr Token;
    ...
    public struct MapplesLogonInformation
    {
        ...
        public MapplesLogonInformation(string username, string password, string domain = ".", bool netOnly=false)
        {
