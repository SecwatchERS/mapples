function(task, response){
    ...
    var output = support_scripts['mapples_create_table']([{"name":"pid", "size":"30px"},{"name":"ppid", "size":"30px"},{"name":"arch", "size":"60px"},{"name":"name", "size":"30em"},{"name": "user", "size": "15em"}, {"name":"path", "size":"15em"}], rows);
    return output;
  }