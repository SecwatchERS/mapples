...
A fully featured .NET 4.0 compatible training agent. Version: {}
    ...
    async def build(self) -> BuildResponse:
        ...
        success_message = f"Mapples {self.uuid} Successfully Built"
        stdout_err = ""
        ...
        try:
            ...
            if stderr:
                stdout_err += f'[stderr]\n{stderr.decode()}' + "\n" + command
            output_path = "{}/Mapples/bin/Release/Mapples.exe".format(agent_build_path.name)
            ...
            if os.path.exists(output_path):
                ...
                targetInteropPath = "/srv/MapplesInterop.dll"
                ...
                shutil.move("{}/MapplesInterop/bin/Release/MapplesInterop.dll".format(agent_build_path.name), targetInteropPath)
                if self.get_parameter('output_type') != "Shellcode":
